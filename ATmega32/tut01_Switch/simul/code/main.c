...
//simulink
#include "./Include/Simulink/DIOD.h"
#include "./Include/Simulink/indicatorLampFunc.h"
...
void main()
{
    ...
    while (1)
    {
        DIOD_U.ctrlSW_B = DIO_ReadPin(PORTA, PIN1);
        DIOD_Y.indicatorlAMP_B = DIOD_indicatorLampFunc(DIOD_U.ctrlSW_B);
        DIO_WritePin(PORTA, PIN0, DIOD_Y.indicatorlAMP_B);
    }
}
