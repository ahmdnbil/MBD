...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOA, LD2_Pin|LL_GPIO_PIN_10|LL_GPIO_PIN_11|LL_GPIO_PIN_12);
  ...
  /**/
  GPIO_InitStruct.Pin = LD2_Pin|LL_GPIO_PIN_10|LL_GPIO_PIN_11|LL_GPIO_PIN_12;
