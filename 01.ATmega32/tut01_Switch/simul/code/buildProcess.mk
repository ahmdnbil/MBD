...
DIODCFile = Include/Simulink/DIOD.c
DIODOFile = Debug/$(subst .c,.o,$(DIODCFile))
DIODDFile = Debug/$(subst .c,.d,$(DIODCFile))

indCFile = Include/Simulink/indicatorLampFunc.c
indOFile = Debug/$(subst .c,.o,$(indCFile))
indDFile = Debug/$(subst .c,.d,$(indCFile))
