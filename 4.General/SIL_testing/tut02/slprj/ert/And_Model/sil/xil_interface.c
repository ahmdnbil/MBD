 ...
 *
 * SIL generated interface for code: "And_Model"
 *
 */
...
/* interface data */
MdlrefDW_And_Model_T And_Model_MdlrefDW;

/* interface (pointer) data */
RT_MODEL_And_Model_T * RTModel_ptr = &(And_Model_MdlrefDW.rtm);
...
XIL_INTERFACE_ERROR_CODE xilInitialize(uint32_T xilFcnId)
{
  ...
  if (xilFcnId == 0) {
    ...
    And_Model_initialize(rt_errorStatus, RTModel_ptr);
