 ...
 * Component: And_Model
 * Component Simulink Path: And_Model
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                And_Model_ssf
...
static RegMdlInfo rtMdlInfo_And_Model[1] = { "",
  ...
  memUnitSizeBytes)
{
  ...
  pCodeInstrServiceData->isTimeProfilingEnabled = false;
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("And_Model");
      mxArray *rhs[3];
      char * simulinkBlockPath = getSimulinkBlockPath(S);
      if (simulinkBlockPath == NULL) {
        ssSetErrorStatus(S,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (S->mdlInfo->genericFcn != (NULL) &&
    ...
    ssRegModelRefMdlInfo(S, (char *)"And_Model", rtMdlInfo_And_Model, 1);
  }
