###########################################################################
## Makefile generated for component 'And_Model'. 
## 
## Makefile     : And_Model.mk
## Generated on : Thu May 29 16:23:25 2025
## Final product: ./And_Model.exe
...
MODELREF_LINK_RSPFILE     = And_Model_ref.rsp
COMPILER_COMMAND_FILE     = And_Model_comp.rsp
CMD_FILE                  = And_Model.rsp
...
DEFINES_STANDARD = -DMODEL=And_Model -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = xil_interface.obj sil_main.obj rtiostream_tcpip.obj xil_interface_lib.obj xil_data_stream.obj xil_services.obj xilcomms_rtiostream.obj xil_rtiostream.obj rtiostream_utils.obj target_io.obj coder_assumptions_app.obj coder_assumptions_data_stream.obj coder_assumptions_rtiostream.obj xil_instrumentation.obj codeinstr_data_stream.obj codeinstr_rtiostream.obj
...
MODELREF_LIBS = D:/ME/Career/04.MBD/Tutorials/SIL_testing/tut02/slprj/ert/And_Model/instrumented/And_Model_rtwlib.lib

LIBS = $(START_DIR)/slprj/ert/And_Model/coderassumptions/lib/And_Model_ca.lib
...
xil_interface.obj : $(START_DIR)/slprj/ert/And_Model/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/slprj/ert/And_Model/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
xil_instrumentation.obj : $(START_DIR)/slprj/ert/And_Model/sil/xil_instrumentation.c
	$(CC) $(CFLAGS) -o "$@" "$<"
