###########################################################################
## Makefile generated for component 'Adding_MIL'. 
## 
## Makefile     : Adding_MIL.mk
## Generated on : Sun Aug 03 23:59:40 2025
## Final product: ./Adding_MIL_rtwlib.lib
...
COMPILER_COMMAND_FILE     = Adding_MIL_comp.rsp
CMD_FILE                  = Adding_MIL.rsp
C_STANDARD_OPTS           = -fwrapv
CPP_STANDARD_OPTS         = -fwrapv
MODELLIB                  = Adding_MIL_rtwlib.lib
...
DEFINES_STANDARD = -DMODEL=Adding_MIL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/Adding_MIL/Adding_MIL.c
...
%.obj : $(START_DIR)/slprj/ert/Adding_MIL/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/Adding_MIL/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/Adding_MIL/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/Adding_MIL/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/ert/Adding_MIL/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Adding_MIL.obj : $(START_DIR)/slprj/ert/Adding_MIL/Adding_MIL.c
	$(CC) $(CFLAGS) -o "$@" "$<"
