...
## Generated on : Mon Aug 04 00:17:30 2025
## Final product: ./Subsystem2.exe
...
MODELREF_LIBS = ../Subsystem2.obj

LIBS = $(START_DIR)/Subsystem2_ert_rtw/coderassumptions/lib/Subsystem2_ca.lib
...
xil_interface.obj : $(START_DIR)/Subsystem2_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/Subsystem2_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
