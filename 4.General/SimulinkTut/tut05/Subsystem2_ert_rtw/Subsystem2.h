...
/* Block signals and states (default storage) for system '<Root>/Subsystem2' */
typedef struct {
...
typedef struct {
  DW_Subsystem2 Subsystem2_b4;         /* '<Root>/Subsystem2' */
} DW;
 ...
 *
 * hilite_system('multirate_control_model/Subsystem2')    - opens subsystem multirate_control_model/Subsystem2
 * hilite_system('multirate_control_model/Subsystem2/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'multirate_control_model'
 * '<S1>'   : 'multirate_control_model/Subsystem2'
 */
#endif                                 /* Subsystem2_h_ */
