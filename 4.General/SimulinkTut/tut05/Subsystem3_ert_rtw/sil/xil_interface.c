 ...
 *
 * SIL generated interface for code: "Subsystem3"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtU.input1);
        ...
        {
          void * dataAddress = (void *) &(rtU.input2);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(uint8_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(rtY.output);
