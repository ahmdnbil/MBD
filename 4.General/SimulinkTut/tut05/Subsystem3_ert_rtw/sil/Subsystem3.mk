...
## Generated on : Mon Aug 04 00:02:09 2025
## Final product: ./Subsystem3.exe
...
MODELREF_LINK_RSPFILE     = Subsystem3_ref.rsp
...
DEFINES_STANDARD = -DMODEL=Subsystem3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
MODELREF_LIBS = ../Subsystem3.obj

LIBS = $(START_DIR)/Subsystem3_ert_rtw/coderassumptions/lib/Subsystem3_ca.lib
...
xil_interface.obj : $(START_DIR)/Subsystem3_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/Subsystem3_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
