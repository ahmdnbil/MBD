...
## Generated on : Sun Aug 03 23:59:55 2025
...
SRCS = $(START_DIR)/Subsystem3_ert_rtw/Subsystem3.c

MAIN_SRC = $(START_DIR)/Subsystem3_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/Subsystem3_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem3_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem3_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Subsystem3_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Subsystem3.obj : $(START_DIR)/Subsystem3_ert_rtw/Subsystem3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Subsystem3_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
