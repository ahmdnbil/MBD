###########################################################################
## Makefile generated for component 'tut04'. 
## 
## Makefile     : tut04.mk
## Generated on : Sat Aug 02 22:37:04 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/tut04.exe
...
START_DIR                 = D:/ME/Career/04.MBD/Tutorials/SimulinkTut/tut04
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = tut04_comp.rsp
CMD_FILE                  = tut04.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/tut04.exe
...
DEFINES_STANDARD = -DMODEL=tut04 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/tut04_ert_rtw/tut04.c

MAIN_SRC = $(START_DIR)/tut04_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/tut04_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/tut04_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/tut04_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/tut04_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/tut04_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(START_DIR)/tut04_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


tut04.obj : $(START_DIR)/tut04_ert_rtw/tut04.c
	$(CC) $(CFLAGS) -o "$@" "$<"
