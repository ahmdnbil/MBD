 ...
 *
 * SIL generated interface for code: "Function0"
 *
 */
   ...
   case XIL_OUTPUT_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *) &(Function0_U.wiperMode);
        ...
        {
          void * dataAddress = (void *) &(Function0_U.rainSnsrErr);
        ...
        {
          void * dataAddress = (void *) &(Function0_U.wiperSpdReq);
          xil_fcnid0_task1_output_u[tableIdx].memUnitLength = 1 * sizeof(uint8_T);
          xil_fcnid0_task1_output_u[tableIdx++].address = (MemUnit_T *)
            dataAddress;
        }
