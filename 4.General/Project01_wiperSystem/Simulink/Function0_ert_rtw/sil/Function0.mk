...
## Generated on : Mon Aug 04 21:13:42 2025
## Final product: ./Function0.exe
...
MODELREF_LINK_RSPFILE     = Function0_ref.rsp
...
MODELREF_LIBS = ../Function0.obj ../Function0_data.obj

LIBS = $(START_DIR)/Function0_ert_rtw/coderassumptions/lib/Function0_ca.lib
...
xil_interface.obj : $(START_DIR)/Function0_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/Function0_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
